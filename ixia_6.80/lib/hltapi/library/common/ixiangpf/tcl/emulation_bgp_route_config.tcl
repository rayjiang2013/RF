...
proc ::ixiangpf::emulation_bgp_route_config { args } {
	...
	set mandatoryParams "{}"
	set fileParams "{-route_file -custom_distribution_file}"
	set procName [lindex [info level [info level]] 0]
	::ixia::logHltapiCommand $procName $args
	::ixia::utrackerLog $procName $args
	return [eval runExecuteCommand "emulation_bgp_route_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
