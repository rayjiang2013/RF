...
#
# Description:
#    This procedure will configure IGMP Host(s). Note that IGMP is only
...
proc ::ixiangpf::emulation_igmp_config { args } {
	...
	return [eval runExecuteCommand "emulation_igmp_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
