...
# Arguments:
#x   -protocol_handle
#x       Network_group_config handle for modify and delete or a NGPF handle for create mode.
#x   -protocol_name
#x   -multiplier
#x   -enable_device
...
proc ::ixiangpf::network_group_config { args } {
	...
	return [eval runExecuteCommand "network_group_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
