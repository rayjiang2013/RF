##Procedure Header
# Name:
#    ixiangpf::traffic_l47_config
#
# Description:
#    This command configures L4-7 AppLibrary Traffic.
#
# Synopsis:
#    ixiangpf::traffic_l47_config
...
sub traffic_l47_config {
	...
	# ixiahlt::logHltapiCommand('traffic_l47_config', $args);
	# ixiahlt::utrackerLog ('traffic_l47_config', $args);

	return ixiangpf::runExecuteCommand('traffic_l47_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
