##Procedure Header
# Name:
#    ixiangpf::emulation_dhcp_config
#
# Description:
...
sub emulation_dhcp_config {
	...
	# ixiahlt::logHltapiCommand('emulation_dhcp_config', $args);
	# ixiahlt::utrackerLog ('emulation_dhcp_config', $args);

	return ixiangpf::runExecuteCommand('emulation_dhcp_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
