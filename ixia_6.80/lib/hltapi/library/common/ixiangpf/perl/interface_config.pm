...
#n       [-vpi_count                                         ANY]
#n       [-vpi_step                                          ANY]
#x       [-enable_flow_control                               CHOICES fixed increment
#x                                                           CHOICES 0 1
#x                                                           DEFAULT 1]
...
#        This parameter can have values between -105,105
#    -intf_ip_addr
...
sub interface_config {
	...
	my @notImplementedParams = (port_handle, atm_enable_coset, atm_enable_pattern_matching, arp_refresh_interval, atm_filler_cell, atm_interface_type, atm_packet_decode_mode, atm_reassembly_timeout, autonegotiation, auto_detect_instrumentation_type, bert_configuration, bert_error_insertion, clocksource, data_integrity, duplex, framing, ignore_link, integrity_signature, integrity_signature_offset, internal_ppm_adjust, intf_mode, intrinsic_latency_adjustment, ns_on_linkup, op_mode, pcs_period, pcs_count, pcs_repeat, pcs_period_type, pcs_lane, pcs_enabled_continuous, pcs_sync_bits, pcs_marker_fields, pgid_128k_bin_enable, pgid_mask, pgid_offset, pgid_mode, pgid_encap, pgid_split1_mask, pgid_split1_offset, pgid_split1_offset_from, pgid_split2_mask, pgid_split2_offset, pgid_split2_offset_from, pgid_split2_width, pgid_split3_mask, pgid_split3_offset, pgid_split3_offset_from, pgid_split3_width, phy_mode, port_rx_mode, ppp_ipv4_address, ppp_ipv4_negotiation, ppp_ipv6_negotiation, ppp_mpls_negotiation, ppp_osi_negotiation, qos_byte_offset, qos_packet_type, qos_pattern_mask, qos_pattern_match, qos_pattern_offset, qos_stats, rpr_hec_seed, rx_c2, rx_fcs, rx_scrambling, sequence_checking, sequence_num_offset, signature, signature_mask, signature_offset, signature_start_offset, speed, transmit_clock_source, transmit_mode, tx_c2, tx_fcs, tx_rx_sync_stats_enable, tx_rx_sync_stats_interval, tx_scrambling, enable_flow_control, flow_control_directed_addr, fcoe_priority_groups, fcoe_support_data_center_mode, fcoe_priority_group_size, fcoe_flow_control_type, fc_credit_starvation_value, fc_no_rrdy_after, fc_tx_ignore_rx_link_faults, tx_ignore_rx_link_faults, fc_max_delay_for_random_value, fc_tx_ignore_available_credits, fc_min_delay_for_random_value, fc_rrdy_response_delays, fc_fixed_delay_value, fc_force_errors, enable_data_center_shared_stats, additional_fcoe_stat_1, additional_fcoe_stat_2, tx_gap_control_mode, tx_lanes, pgid_split1_width);
	my @mandatoryParams = (port_handle);
	my @fileParams = ();

	# ixiahlt::logHltapiCommand('interface_config', $args);
	# ixiahlt::utrackerLog ('interface_config', $args);

	return ixiangpf::runExecuteCommand('interface_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
