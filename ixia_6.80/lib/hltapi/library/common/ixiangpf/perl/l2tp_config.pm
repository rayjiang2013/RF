...
sub l2tp_config {
	...
	# ixiahlt::logHltapiCommand('l2tp_config', $args);
	# ixiahlt::utrackerLog ('l2tp_config', $args);

	return ixiangpf::runExecuteCommand('l2tp_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
