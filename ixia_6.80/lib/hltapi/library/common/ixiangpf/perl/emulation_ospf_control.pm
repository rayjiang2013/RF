...
sub emulation_ospf_control {
	...
	# ixiahlt::logHltapiCommand('emulation_ospf_control', $args);
	# ixiahlt::utrackerLog ('emulation_ospf_control', $args);

	return ixiangpf::runExecuteCommand('emulation_ospf_control', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
