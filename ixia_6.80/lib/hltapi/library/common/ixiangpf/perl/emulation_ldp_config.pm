...
sub emulation_ldp_config {
	...
	# ixiahlt::logHltapiCommand('emulation_ldp_config', $args);
	# ixiahlt::utrackerLog ('emulation_ldp_config', $args);

	return ixiangpf::runExecuteCommand('emulation_ldp_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
