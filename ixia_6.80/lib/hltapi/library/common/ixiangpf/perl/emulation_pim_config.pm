...
sub emulation_pim_config {
	...
	# ixiahlt::logHltapiCommand('emulation_pim_config', $args);
	# ixiahlt::utrackerLog ('emulation_pim_config', $args);

	return ixiangpf::runExecuteCommand('emulation_pim_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
