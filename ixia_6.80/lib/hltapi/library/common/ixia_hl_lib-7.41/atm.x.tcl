...
#? master type "::hag::ixnmeta::/vport/protocolStack/atm"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/atm
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/atm]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/atm'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/atm {
  ...
  typevariable GenerateOptions {
    ...
    -input-ixnmetadata-file ./lib/ixnmetadata-7.41/vport-ixnmetadata.xml
    ...
    -type-for-command protocolStack/atm
    -use-settings-for {}
  }
  
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/atm
  ...
  option -pppox \
    ...
    -default "" \
    -readonly false
  method _c_pppox {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/pppox $t $v }
  method _v_pppox {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/pppox $t $v }
  method _g_pppox {t} { $self _cget_basic $t }
  option -pppoxmulti \
    -cgetmethod _g_pppoxmulti -configuremethod _c_pppoxmulti -validatemethod _v_pppoxmulti \
    -default "" \
    -readonly false
  method _c_pppoxmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/pppox $t $v }
  method _v_pppoxmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/pppox $t $v }
  ...
  option -dhcp_server_endpoint \
    ...
    -default "" \
    -readonly false
  method _c_dhcp_server_endpoint {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/dhcpServerEndpoint $t $v }
  method _v_dhcp_server_endpoint {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/dhcpServerEndpoint $t $v }
  ...
  option -dhcp_server_endpointmulti \
    ...
    -default "" \
    -readonly false
  method _c_dhcp_server_endpointmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/dhcpServerEndpoint $t $v }
  method _v_dhcp_server_endpointmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/dhcpServerEndpoint $t $v }
  ...
  option -emulated_router_endpoint \
    ...
    -default "" \
    -readonly false
  method _c_emulated_router_endpoint {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/emulatedRouterEndpoint $t $v }
  method _v_emulated_router_endpoint {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/emulatedRouterEndpoint $t $v }
  ...
  option -emulated_router_endpointmulti \
    ...
    -default "" \
    -readonly false
  method _c_emulated_router_endpointmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/emulatedRouterEndpoint $t $v }
  method _v_emulated_router_endpointmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/emulatedRouterEndpoint $t $v }
  ...
  option -pppox_endpoint \
    ...
    -default "" \
    -readonly false
  method _c_pppox_endpoint {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/pppoxEndpoint $t $v }
  method _v_pppox_endpoint {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/pppoxEndpoint $t $v }
  ...
  option -pppox_endpointmulti \
    ...
    -default "" \
    -readonly false
  method _c_pppox_endpointmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/pppoxEndpoint $t $v }
  method _v_pppox_endpointmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/pppoxEndpoint $t $v }
  ...
  option -dhcp_endpoint \
    ...
    -default "" \
    -readonly false
  method _c_dhcp_endpoint {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/dhcpEndpoint $t $v }
  method _v_dhcp_endpoint {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/dhcpEndpoint $t $v }
  ...
  option -dhcp_endpointmulti \
    ...
    -default "" \
    -readonly false
  method _c_dhcp_endpointmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/dhcpEndpoint $t $v }
  method _v_dhcp_endpointmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/dhcpEndpoint $t $v }
  method _g_dhcp_endpointmulti {t} { $self _cget_basic $t }
  option -ip \
    -cgetmethod _g_ip -configuremethod _c_ip -validatemethod _v_ip \
    -default "" \
    -readonly false
  method _c_ip {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/ip $t $v }
  method _v_ip {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/ip $t $v }
  method _g_ip {t} { $self _cget_basic $t }
  option -ipmulti \
    -cgetmethod _g_ipmulti -configuremethod _c_ipmulti -validatemethod _v_ipmulti \
    -default "" \
    -readonly false
  method _c_ipmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/ip $t $v }
  method _v_ipmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/ip $t $v }
  ...
  option -ip_endpoint \
    ...
    -default "" \
    -readonly false
  method _c_ip_endpoint {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/ipEndpoint $t $v }
  method _v_ip_endpoint {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/ipEndpoint $t $v }
  ...
  option -ip_endpointmulti \
    ...
    -default "" \
    -readonly false
  method _c_ip_endpointmulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/ipEndpoint $t $v }
  method _v_ip_endpointmulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/ipEndpoint $t $v }
  ...
  option -emulated_router \
    ...
    -default "" \
    -readonly false
  method _c_emulated_router {t v} { $self _configure_kList_as_list /vport/protocolStack/atm/emulatedRouter $t $v }
  method _v_emulated_router {t v} { $self _validate_kList_as_list /vport/protocolStack/atm/emulatedRouter $t $v }
  ...
  option -emulated_routermulti \
    ...
    -default "" \
    -readonly false
  method _c_emulated_routermulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/atm/emulatedRouter $t $v }
  method _v_emulated_routermulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/atm/emulatedRouter $t $v }
...
#@ ancestors for ::hag::ixnmeta::/vport/protocolStack/atm
...
#@ end of ancestors for ::hag::ixnmeta::/vport/protocolStack/atm
...
if {[file exists [set dir]/tailor_protocolStack_atm.tcl]} {
    set fn [set dir]/tailor_protocolStack_atm.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
} elseif {[file exists [set dir]/../tailor_protocolStack_atm.tcl]} {
    set fn [set dir]/../tailor_protocolStack_atm.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
}
...
if 0 { 
    if {![set file_found]} {
      return -code error  "Could not find required tailorfile 'tailor_protocolStack_atm.tcl'"
    }
}

#-------------------------------------------------------------
# Generated by the hag on 
#     Fri Jan 16 03:31:09 PST 2015
#-------------------------------------------------------------
# package requires, etc.
package require snit
#-------------------------------------------------------------

if {[llength [info commands ::ixia::atm]]} {
    rename ::ixia::atm ""
}
::ixia::hag::ixn::types::shell ::ixia::atm  -config-multiplier-option-groups 1  -config-typepathways  [list /vport/protocolStack/atm]
#
...
proc ::ixia::atm_config {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::atm config [set args]] r]
    if {$fail} {
    ...
    eval [concat {::ixia::atm config} [set args]]
  }
}

proc ::ixia::atm_control {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::atm control [set args]] r]
    if {$fail} {
      return [list [list status 0] [list log $r\n$::errorInfo]]
    } else {
...
proc ::ixia::atm_stats {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail  [catch [concat {::ixia::atm stats} [set args]] r]
    if {$fail} {
      return [list [list status 0] [list log $r\n$::errorInfo]]
    } else {
    ...
    eval [concat {::ixia::atm stats} [set args]]
  }
}
