...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BEOS_THREADS': 0,
 'BINDIR': '/tmp/alt/bin',
 'BINLIBDEST': '/tmp/alt/lib/python2.7',
 'BLDLIBRARY': '-L. -lpython2.7',
 'BLDSHARED': 'gcc -pthread -shared -Wl,-rpath /tmp/alt/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--prefix=/tmp/alt' '--enable-unicode=ucs4' '--enable-shared' 'LDFLAGS=-Wl,-rpath /tmp/alt/lib'",
 'CONFINCLUDEDIR': '/tmp/alt/include',
 'CONFINCLUDEPY': '/tmp/alt/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++',
 'C_THREADS': 0,
 'DESTDIRS': '/tmp/alt /tmp/alt/lib /tmp/alt/lib/python2.7 /tmp/alt/lib/python2.7/lib-dynload',
 'DESTLIB': '/tmp/alt/lib/python2.7',
 'DESTPATH': '',
 'DESTSHARED': '/tmp/alt/lib/python2.7/lib-dynload',
 'DIRMODE': 755,
 ...
 'HURD_C_THREADS': 0,
 'INCLDIRSTOMAKE': '/tmp/alt/include /tmp/alt/include /tmp/alt/include/python2.7 /tmp/alt/include/python2.7',
 'INCLUDEDIR': '/tmp/alt/include',
 'INCLUDEPY': '/tmp/alt/include/python2.7',
 ...
 'LDFLAGS': '-Wl,-rpath /tmp/alt/lib',
 'LDLAST': '',
 'LDLIBRARY': 'libpython2.7.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-rpath /tmp/alt/lib',
 'LIBC': '',
 'LIBDEST': '/tmp/alt/lib/python2.7',
 'LIBDIR': '/tmp/alt/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBP': '/tmp/alt/lib/python2.7',
 'LIBPC': '/tmp/alt/lib/pkgconfig',
 'LIBPL': '/tmp/alt/lib/python2.7/config',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmp/alt/lib/python2.7',
 'MACH_C_THREADS': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-2.7.6:',
 'SCRIPTDIR': '/tmp/alt/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-2.7.6: ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/tmp/Python-2.7.6',
 'abs_srcdir': '/tmp/Python-2.7.6',
 'build': 'x86_64-unknown-linux-gnu',
 'datarootdir': '/tmp/alt/share',
 'exec_prefix': '/tmp/alt',
