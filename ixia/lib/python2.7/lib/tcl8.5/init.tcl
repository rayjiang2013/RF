...
#
# ActiveState ActiveTcl 8.5.13.296436 Linux/x86_64, Mon Nov 19 20:45:09 PST 2012
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {linux-x86_64}
	buildtime,sec {1353386709}
	buildtime,fmt {Mon Nov 19 20:45:09 PST 2012}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.13.296436 Linux/x86_64 @ Mon Nov 19 20:45:09 PST 2012 / normal}
    }
}
