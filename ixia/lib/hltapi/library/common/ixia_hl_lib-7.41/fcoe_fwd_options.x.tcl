...
#? master type "::hag::ixnmeta::/vport/protocolStack/fcoeFwdOptions"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/fcoeFwdOptions
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/fcoeFwdOptions]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/fcoeFwdOptions'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/fcoeFwdOptions {
  ...
  option -override_global_rate \
    -cgetmethod _g_override_global_rate -configuremethod _c_override_global_rate -validatemethod _v_override_global_rate \
    -default "" \
    -readonly false
  method _c_override_global_rate {t v} { $self _configure_basic $t $v }
  method _v_override_global_rate {t v} { ::ixia::hag::ixn::validate::kBool $t $v }
  method _g_override_global_rate {t} { $self _cget_kBool $t }
  option -unsol_discovery_tpid \
    -cgetmethod _g_unsol_discovery_tpid -configuremethod _c_unsol_discovery_tpid -validatemethod _v_unsol_discovery_tpid \
    -default "" \
    -readonly false
  method _c_unsol_discovery_tpid {t v} { $self _configure_basic $t $v }
  method _v_unsol_discovery_tpid {t v} { ::ixia::hag::ixn::validate::kString $t $v }
  method _g_unsol_discovery_tpid {t} { $self _cget_basic $t }
  # multiplier 
  method _m_unsol_discovery_tpid {mog_args m n other_args} {  $Shell _m_kString  $self $mog_args $m $n $other_args -unsol_discovery_tpid }
  ...
  typevariable Opt2IxnName -array {
    ...
    -override_global_rate overrideGlobalRate
    -unsol_discovery_tpid unsolDiscoveryTpid
  }
  #
  variable MultiplierOptionGroups {
    ...
    _m_unsol_discovery_tpid {-unsol_discovery_tpid_format -unsol_discovery_tpid_base -unsol_discovery_tpid_incr}
  }
}

#@ ancestors for ::hag::ixnmeta::/vport/protocolStack/fcoeFwdOptions
...
#@ end of ancestors for ::hag::ixnmeta::/vport/protocolStack/fcoeFwdOptions
...
if {[file exists [set dir]/tailor_fcoeFwdOptions.tcl]} {
    set fn [set dir]/tailor_fcoeFwdOptions.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
} elseif {[file exists [set dir]/../tailor_fcoeFwdOptions.tcl]} {
    set fn [set dir]/../tailor_fcoeFwdOptions.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
}
...
if 0 { 
    if {![set file_found]} {
      return -code error  "Could not find required tailorfile 'tailor_fcoeFwdOptions.tcl'"
    }
}

#-------------------------------------------------------------
# Generated by the hag on 
#     Fri Jan 16 03:36:52 PST 2015
#-------------------------------------------------------------
# package requires, etc.
package require snit
#-------------------------------------------------------------

if {[llength [info commands ::ixia::fcoe_fwd_options]]} {
    rename ::ixia::fcoe_fwd_options ""
}
::ixia::hag::ixn::types::shell ::ixia::fcoe_fwd_options  -config-multiplier-option-groups 1  -config-typepathways  [list /vport/protocolStack/fcoeFwdOptions]
#
...
proc ::ixia::fcoe_fwd_options_config {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::fcoe_fwd_options config [set args]] r]
    if {$fail} {
    ...
    eval [concat {::ixia::fcoe_fwd_options config} [set args]]
  }
}

proc ::ixia::fcoe_fwd_options_control {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "fcoe_fwd_options: control not supported"]]
  } else {
      return -code error "fcoe_fwd_options: control not supported"
  }
}

proc ::ixia::fcoe_fwd_options_stats {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "fcoe_fwd_options: stats not supported"]]
  } else {
      return -code error "fcoe_fwd_options: stats not supported"
  }
}
