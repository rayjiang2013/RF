...
sub emulation_isis_config {
	...
	# ixiahlt::logHltapiCommand('emulation_isis_config', $args);
	# ixiahlt::utrackerLog ('emulation_isis_config', $args);

	return ixiangpf::runExecuteCommand('emulation_isis_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
