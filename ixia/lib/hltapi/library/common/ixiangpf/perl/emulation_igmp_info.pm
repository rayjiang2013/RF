...
#
# Description:
#    This procedure gathers IGMP statistics.
...
sub emulation_igmp_info {
	...
	# ixiahlt::logHltapiCommand('emulation_igmp_info', $args);
	# ixiahlt::utrackerLog ('emulation_igmp_info', $args);

	return ixiangpf::runExecuteCommand('emulation_igmp_info', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
