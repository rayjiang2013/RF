...
sub emulation_bgp_route_config {

	my $args = shift(@_);

	my @notImplementedParams = ();
	my @mandatoryParams = ();
	my @fileParams = (route_file, custom_distribution_file);

	# ixiahlt::logHltapiCommand('emulation_bgp_route_config', $args);
	# ixiahlt::utrackerLog ('emulation_bgp_route_config', $args);

	return ixiangpf::runExecuteCommand('emulation_bgp_route_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
