...
sub ixvm_config {
	...
	# ixiahlt::logHltapiCommand('ixvm_config', $args);
	# ixiahlt::utrackerLog ('ixvm_config', $args);

	return ixiangpf::runExecuteCommand('ixvm_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
