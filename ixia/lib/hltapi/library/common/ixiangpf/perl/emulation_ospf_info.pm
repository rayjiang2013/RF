...
sub emulation_ospf_info {
	...
	# ixiahlt::logHltapiCommand('emulation_ospf_info', $args);
	# ixiahlt::utrackerLog ('emulation_ospf_info', $args);

	return ixiangpf::runExecuteCommand('emulation_ospf_info', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
