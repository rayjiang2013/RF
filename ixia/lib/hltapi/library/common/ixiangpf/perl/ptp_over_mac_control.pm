...
sub ptp_over_mac_control {
	...
	# ixiahlt::logHltapiCommand('ptp_over_mac_control', $args);
	# ixiahlt::utrackerLog ('ptp_over_mac_control', $args);

	return ixiangpf::runExecuteCommand('ptp_over_mac_control', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
