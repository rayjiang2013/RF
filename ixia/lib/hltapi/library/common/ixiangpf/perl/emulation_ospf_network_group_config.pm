...
#x       [-external_prefix_options                NUMERIC]
...
#x       [-intra_area_prefix_options              NUMERIC]
#x       [-intra_area_link_state_id               IPV4]
#x       [-intra_area_link_state_id_prefix        IPV4]
#x       [-summary_prefix_options                 NUMERIC]
#x       [-summary_link_state_id                  IPV4]
#x       [-summary_link_state_id_prefix           NUMERIC]
#x       [-linklsa_options                        NUMERIC]
#x       [-linklsa_router_priority                NUMERIC]
#x       [-linklsa_link_local_address             IPV6]
#x       [-linklsa_metric                         NUMERIC]
#x       [-linklsa_prefix_options                 NUMERIC]
...
#x       [-inter_area_prefix_prefix_options       NUMERIC]
...
#x   -intra_area_prefix_options
#x       Prefix Options
#x   -intra_area_link_state_id
#x       Link State Id of the simulated IPv6 network
#x   -intra_area_link_state_id_prefix
#x       Link State Id Prefix
#x   -summary_prefix_options
#x       Prefix Options
#x   -summary_link_state_id
#x       Link State Id of the simulated IPv6 network
#x   -summary_link_state_id_prefix
#x       Link State Id Prefix
#x   -linklsa_options
#x       Options
...
#x       Metric
#x   -inter_area_prefix_prefix_options
#x       Prefix Options
...
sub emulation_ospf_network_group_config {
	...
	# ixiahlt::logHltapiCommand('emulation_ospf_network_group_config', $args);
	# ixiahlt::utrackerLog ('emulation_ospf_network_group_config', $args);

	return ixiangpf::runExecuteCommand('emulation_ospf_network_group_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
