...
#    -port_handle
#        The port handle for which the ptp_over_ip stats need to
#        be retrieved
#x   -mode
...
proc ::ixiangpf::ptp_over_ip_stats { args } {
	...
	return [eval runExecuteCommand "ptp_over_ip_stats" $notImplementedParams $mandatoryParams $fileParams $args]
}
