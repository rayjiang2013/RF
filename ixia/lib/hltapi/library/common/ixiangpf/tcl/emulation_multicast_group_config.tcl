...
proc ::ixiangpf::emulation_multicast_group_config { args } {
	...
	return [eval runExecuteCommand "emulation_multicast_group_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
