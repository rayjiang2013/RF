...
proc ::ixiangpf::emulation_isis_network_group_config { args } {
	...
	return [eval runExecuteCommand "emulation_isis_network_group_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
