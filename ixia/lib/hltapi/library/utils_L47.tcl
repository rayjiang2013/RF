    ...
    switch -- $mode {
        ...
        start {
            if {[isUNIX]} {
                ...
                set retValueClicks [eval "clientSend $::ixTclSvrHandle \
                        {clock clicks}"]
                set retValueSeconds [eval "clientSend $::ixTclSvrHandle \
                        {clock seconds}"]
            } else {
                    ...
                    if {[catch {file mkdir $results_dir} dir_err]} {
                        ...
                        debug "results_dir = $results_dir"
                            ...
                            foreach fileName $nameList {
                                ...
                                set tmp_file_name [eval clientSend $::ixTclSvrHandle \
                                            \{file normalize $tmp_file_name\}]
                                if {![eval clientSend $::ixTclSvrHandle \
