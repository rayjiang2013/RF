...
proc ::ixia::emulation_pbb_config { args } {
    ...
    if {$::ixia::executeOnTclServer} {
        ...
        set retValue [eval clientSend $::ixTclSvrHandle  \{::ixia::emulation_pbb_config $args\}]
...
proc ::ixia::emulation_pbb_trunk_config { args } {
    ...
    if {$::ixia::executeOnTclServer} {
        ...
        set retValue [eval clientSend $::ixTclSvrHandle  \{::ixia::emulation_pbb_trunk_config $args\}]
...
proc ::ixia::emulation_pbb_custom_tlv_config { args } {
    ...
    if {$::ixia::executeOnTclServer} {
        ...
        set retValue [eval clientSend $::ixTclSvrHandle  \{::ixia::emulation_pbb_custom_tlv_config $args\}]
...
proc ::ixia::emulation_pbb_info { args } {
    ...
    if {$::ixia::executeOnTclServer} {
        ...
        set retValue [eval clientSend $::ixTclSvrHandle  \{::ixia::emulation_pbb_info $args\}]
...
proc ::ixia::emulation_pbb_control { args } {
    ...
    if {$::ixia::executeOnTclServer} {
        ...
        set retValue [eval clientSend $::ixTclSvrHandle  \{::ixia::emulation_pbb_control $args\}]
