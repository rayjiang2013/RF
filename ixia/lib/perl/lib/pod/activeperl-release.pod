=head1 ActivePerl 1800 -- Release Notes
...
was installed in F</opt/ActivePerl-5.18> then the HTML documentation
would be located in F</opt/ActivePerl-5.18/html>.
