...
if {[catch {package require IxTclNetwork}]} { 
	logMsg "Error in package require IxTclNetwork"
	return 1
}
...
namespace eval ixTclNetworkProtocol {
    variable noArgList
...
package provide IxTclNetworkProtocol 7.51.1086.33 
