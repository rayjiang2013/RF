##Procedure Header
# Name:
#    ixiangpf::multivalue_config
#
# Description:
#    This method can be used to create and/or modify multivalue structures.
#
# Synopsis:
#    ixiangpf::multivalue_config
...
#x       The handle must belong to an equivalent protocol stack confignured in the same topology as the protocols stack whose atrtibute will be set using the resulting multivalue.
#
# Return Values:
...
sub multivalue_config {

	my $args = shift(@_);

	my @notImplementedParams = ();
	my @mandatoryParams = ();
	my @fileParams = (values_file);

	# ixiahlt::logHltapiCommand('multivalue_config', $args);
	# ixiahlt::utrackerLog ('multivalue_config', $args);

	return ixiangpf::runExecuteCommand('multivalue_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
