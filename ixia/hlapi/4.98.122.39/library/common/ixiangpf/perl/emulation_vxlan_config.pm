##Procedure Header
# Name:
#    ixiangpf::emulation_vxlan_config
#
# Description:
...
sub emulation_vxlan_config {
	...
	# ixiahlt::logHltapiCommand('emulation_vxlan_config', $args);
	# ixiahlt::utrackerLog ('emulation_vxlan_config', $args);

	return ixiangpf::runExecuteCommand('emulation_vxlan_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
