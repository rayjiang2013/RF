##Procedure Header
# Name:
#    ixiangpf::emulation_igmp_querier_config
#
# Description:
#    This procedure will configure IGMP Querier(s).
#
# Synopsis:
#    ixiangpf::emulation_igmp_querier_config
#        -mode                               CHOICES create
...
sub emulation_igmp_querier_config {
	...
	# ixiahlt::logHltapiCommand('emulation_igmp_querier_config', $args);
	# ixiahlt::utrackerLog ('emulation_igmp_querier_config', $args);

	return ixiangpf::runExecuteCommand('emulation_igmp_querier_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
