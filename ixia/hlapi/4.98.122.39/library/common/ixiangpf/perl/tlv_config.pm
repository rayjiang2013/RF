...
#
# Description:
#    This command will create, modify or remove a TLV template or a TLV.
#
# Synopsis:
#    ixiangpf::tlv_config
#x       [-handle                        ANY]
...
sub tlv_config {
	...
	# ixiahlt::logHltapiCommand('tlv_config', $args);
	# ixiahlt::utrackerLog ('tlv_config', $args);

	return ixiangpf::runExecuteCommand('tlv_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
