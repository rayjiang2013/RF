...
sub test_control {
	...
	# ixiahlt::logHltapiCommand('test_control', $args);
	# ixiahlt::utrackerLog ('test_control', $args);

	return ixiangpf::runExecuteCommand('test_control', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
