...
sub emulation_ancp_config {
	...
	# ixiahlt::logHltapiCommand('emulation_ancp_config', $args);
	# ixiahlt::utrackerLog ('emulation_ancp_config', $args);

	return ixiangpf::runExecuteCommand('emulation_ancp_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
