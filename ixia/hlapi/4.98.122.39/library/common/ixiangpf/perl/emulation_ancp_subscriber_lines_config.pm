...
sub emulation_ancp_subscriber_lines_config {
	...
	# ixiahlt::logHltapiCommand('emulation_ancp_subscriber_lines_config', $args);
	# ixiahlt::utrackerLog ('emulation_ancp_subscriber_lines_config', $args);

	return ixiangpf::runExecuteCommand('emulation_ancp_subscriber_lines_config', \@notImplementedParams, \@mandatoryParams, \@fileParams, $args);
}
