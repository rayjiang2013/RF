...
#
# Description:
#    This method is used to configure traffic tag for a protocol stack
#
# Synopsis:
#    ::ixiangpf::traffic_tag_config
#x       [-handle  ANY]
...
proc ::ixiangpf::traffic_tag_config { args } {
	...
	return [eval runExecuteCommand "traffic_tag_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
