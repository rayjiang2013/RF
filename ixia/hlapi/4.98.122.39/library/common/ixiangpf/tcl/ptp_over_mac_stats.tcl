...
proc ::ixiangpf::ptp_over_mac_stats { args } {
	...
	return [eval runExecuteCommand "ptp_over_mac_stats" $notImplementedParams $mandatoryParams $fileParams $args]
}
