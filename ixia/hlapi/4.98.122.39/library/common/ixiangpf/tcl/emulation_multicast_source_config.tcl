##Procedure Header
# Name:
#    ::ixiangpf::emulation_multicast_source_config
#
# Description:
...
proc ::ixiangpf::emulation_multicast_source_config { args } {
	...
	return [eval runExecuteCommand "emulation_multicast_source_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
