...
proc ::ixiangpf::emulation_ospf_topology_route_config { args } {
	...
	return [eval runExecuteCommand "emulation_ospf_topology_route_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
