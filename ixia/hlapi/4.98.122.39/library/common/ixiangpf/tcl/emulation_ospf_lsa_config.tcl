...
proc ::ixiangpf::emulation_ospf_lsa_config { args } {
	...
	return [eval runExecuteCommand "emulation_ospf_lsa_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
