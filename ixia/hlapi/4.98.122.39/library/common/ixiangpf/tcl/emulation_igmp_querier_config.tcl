...
proc ::ixiangpf::emulation_igmp_querier_config { args } {
	...
	return [eval runExecuteCommand "emulation_igmp_querier_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
