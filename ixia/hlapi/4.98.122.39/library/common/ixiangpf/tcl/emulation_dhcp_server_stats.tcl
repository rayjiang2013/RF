...
proc ::ixiangpf::emulation_dhcp_server_stats { args } {
	...
	return [eval runExecuteCommand "emulation_dhcp_server_stats" $notImplementedParams $mandatoryParams $fileParams $args]
}
