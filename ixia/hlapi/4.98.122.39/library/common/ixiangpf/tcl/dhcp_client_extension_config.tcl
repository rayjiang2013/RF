##Procedure Header
# Name:
#    ::ixiangpf::dhcp_client_extension_config
#
# Description:
...
proc ::ixiangpf::dhcp_client_extension_config { args } {
	...
	return [eval runExecuteCommand "dhcp_client_extension_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
