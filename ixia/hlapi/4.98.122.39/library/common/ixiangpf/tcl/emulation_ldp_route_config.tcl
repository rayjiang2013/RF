...
proc ::ixiangpf::emulation_ldp_route_config { args } {
	...
	return [eval runExecuteCommand "emulation_ldp_route_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
