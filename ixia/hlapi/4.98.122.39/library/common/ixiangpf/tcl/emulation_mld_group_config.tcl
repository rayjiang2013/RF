...
proc ::ixiangpf::emulation_mld_group_config { args } {
	...
	return [eval runExecuteCommand "emulation_mld_group_config" $notImplementedParams $mandatoryParams $fileParams $args]
}
