...
#R /vport/protocolStack/ethernetEndpoint/range/macRange ( ../vlanRange - ) 
# Generated for relative support for:
# ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/macRange
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint/range/vlanRange
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange {
  ...
  typevariable GenerateOptions {
    ...
    -anx2hlt-hltapi-param-element-attrs {@path-ethernetEndpoint/range/macRange,../vlanRange/name,value_translator cgs.xlt.hag_vlan_id_info}
    -anx2hlt-typepath-links {}
    -children-processing include-all
    -children-processing-for-types {}
    -command-name ethernetrange
    ...
    -input-tailor-file tailor_ethernetRange.tcl
    -input-tailor-file-mandatory 1
    -ixn-tclserver-hostname localhost
    -option-prefixes-for-types {*/protocolStack/ethernetEndpoint/range/macRange mac_range}
    ...
    -relative-includes {*/protocolStack/ethernetEndpoint/range/macRange {{../vlanRange -}}}
    -rules-file {}
    -shared-includes {}
    -sub-commands config
    -type-for-command ethernetEndpoint/range/macRange
    -use-settings-for ethernetrange_command
  }
  
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint/range/vlanRange
  ...
  option -vlan_id_info \
    ...
    -default "" \
    -readonly false
  method _c_vlan_id_info {t v} { $self _configure_kList_as_list /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo $t $v }
  method _v_vlan_id_info {t v} { $self _validate_kList_as_list /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo $t $v }
  ...
  option -vlan_id_infomulti \
    ...
    -default "" \
    -readonly false
  method _c_vlan_id_infomulti {t v} { $self _configure_kList_as_multiplier /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo $t $v }
  method _v_vlan_id_infomulti {t v} { $self _validate_kList_as_multiplier /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo $t $v }
...
#? Children types for relative ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/macRange 
#-->  "::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo
package require snit
foreach {ns} {
  ::ixia::hag::ixn ::ixia::hag::ixn::auto ::ixia::hag::ixn::types
} {
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo {
  ...
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint/range/vlanRange/vlanIdInfo
  variable AncestorIncludeLevelForCreate  0
  variable AncestorIncludeLevelForAdd  0
  # Ancestors that we auto-created and are managing ourselves
  # as opposed to those linked in via -parent_handle or some other
...
#? master type "::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/macRange"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint/range/macRange
package require snit
foreach {ns} {
  ::ixia::hag::ixn ::ixia::hag::ixn::auto ::ixia::hag::ixn::types
} {
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/macRange]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/macRange'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/macRange {
  ...
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint/range/macRange
  ...
  option -mac_range_object_id \
    -cgetmethod _g_mac_range_object_id -configuremethod _c_mac_range_object_id -validatemethod _v_mac_range_object_id \
    -default "" \
    -readonly false
  method _c_mac_range_object_id {t v} {  }
  method _v_mac_range_object_id {t v} { ::ixia::hag::ixn::validate::kString $t $v }
  method _g_mac_range_object_id {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_increment_by \
    -cgetmethod _g_mac_range_increment_by -configuremethod _c_mac_range_increment_by -validatemethod _v_mac_range_increment_by \
    -default "" \
    -readonly false
  method _c_mac_range_increment_by {t v} { $self _configure_basic $t $v }
  method _v_mac_range_increment_by {t v} { ::ixia::hag::ixn::validate::kString $t $v }
  method _g_mac_range_increment_by {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_name \
    -cgetmethod _g_mac_range_name -configuremethod _c_mac_range_name -validatemethod _v_mac_range_name \
    -default "" \
    -readonly false
  method _c_mac_range_name {t v} { $self _configure_basic $t $v }
  method _v_mac_range_name {t v} { ::ixia::hag::ixn::validate::kString $t $v }
  method _g_mac_range_name {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_count \
    -cgetmethod _g_mac_range_count -configuremethod _c_mac_range_count -validatemethod _v_mac_range_count \
    -default "" \
    -readonly false
  method _c_mac_range_count {t v} { $self _configure_basic $t $v }
  method _v_mac_range_count {t v} { ::ixia::hag::ixn::validate::kInteger64 $t $v }
  method _g_mac_range_count {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_mac \
    -cgetmethod _g_mac_range_mac -configuremethod _c_mac_range_mac -validatemethod _v_mac_range_mac \
    -default "" \
    -readonly false
  method _c_mac_range_mac {t v} { $self _configure_basic $t $v }
  method _v_mac_range_mac {t v} { ::ixia::hag::ixn::validate::kString $t $v }
  method _g_mac_range_mac {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_mtu \
    -cgetmethod _g_mac_range_mtu -configuremethod _c_mac_range_mtu -validatemethod _v_mac_range_mtu \
    -default "" \
    -readonly false
  method _c_mac_range_mtu {t v} { $self _configure_basic $t $v }
  method _v_mac_range_mtu {t v} { ::ixia::hag::ixn::validate::kInteger64 $t $v }
  method _g_mac_range_mtu {t} { $self _cget_basic $t }
  # multiplier 
  ...
  option -mac_range_enabled \
    -cgetmethod _g_mac_range_enabled -configuremethod _c_mac_range_enabled -validatemethod _v_mac_range_enabled \
    -default "" \
    -readonly false
  method _c_mac_range_enabled {t v} { $self _configure_basic $t $v }
  method _v_mac_range_enabled {t v} { ::ixia::hag::ixn::validate::kBool $t $v }
  method _g_mac_range_enabled {t} { $self _cget_kBool $t }
  # End options that are mapped to ixn properties
  #------------------------------------------------------
  ...
  typevariable Opt2IxnName -array {
    ...
    -mac_range_object_id objectId
    -mac_range_increment_by incrementBy
    -mac_range_name name
    -mac_range_count count
    -mac_range_mac mac
    -mac_range_mtu mtu
    -mac_range_enabled enabled
  }
  #
  variable MultiplierOptionGroups {
...
#@ ancestors for ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/macRange
#@@ ancestor "::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint
package require snit
foreach {ns} {
  ::ixia::hag::ixn ::ixia::hag::ixn::auto ::ixia::hag::ixn::types
} {
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint {
  ...
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint
  variable AncestorIncludeLevelForCreate  0
  variable AncestorIncludeLevelForAdd  0
  # Ancestors that we auto-created and are managing ourselves
  # as opposed to those linked in via -parent_handle or some other
  ...
  # XCHILD
  # /vport/protocolStack/ethernetEndpoint/range
...
#@@ ancestor "::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint/range
package require snit
foreach {ns} {
  ::ixia::hag::ixn ::ixia::hag::ixn::auto ::ixia::hag::ixn::types
} {
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range {
  ...
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint/range
  variable AncestorIncludeLevelForCreate  0
  variable AncestorIncludeLevelForAdd  0
  # Ancestors that we auto-created and are managing ourselves
  # as opposed to those linked in via -parent_handle or some other
...
#@ end of ancestors for ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/macRange
...
if {[file exists [set dir]/tailor_ethernetRange.tcl]} {
    set fn [set dir]/tailor_ethernetRange.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
} elseif {[file exists [set dir]/../tailor_ethernetRange.tcl]} {
    set fn [set dir]/../tailor_ethernetRange.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
}
...
if 1 { 
    if {![set file_found]} {
      return -code error  "Could not find required tailorfile 'tailor_ethernetRange.tcl'"
    }
}

#-------------------------------------------------------------
# Generated by the hag on 
#     Sun Aug 02 04:36:01 PDT 2015
#-------------------------------------------------------------
# package requires, etc.
package require snit
#-------------------------------------------------------------

if {[llength [info commands ::ixia::ethernetrange]]} {
    rename ::ixia::ethernetrange ""
}
::ixia::hag::ixn::types::shell ::ixia::ethernetrange  -config-multiplier-option-groups 1  -config-typepathways  [list /vport/protocolStack/ethernetEndpoint/range/macRange]
#
...
proc ::ixia::ethernetrange_config {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::ethernetrange config [set args]] r]
    if {$fail} {
    ...
    eval [concat {::ixia::ethernetrange config} [set args]]
  }
}

proc ::ixia::ethernetrange_control {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "ethernetrange: control not supported"]]
  } else {
      return -code error "ethernetrange: control not supported"
  }
}

proc ::ixia::ethernetrange_stats {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "ethernetrange: stats not supported"]]
  } else {
      return -code error "ethernetrange: stats not supported"
  }
}
