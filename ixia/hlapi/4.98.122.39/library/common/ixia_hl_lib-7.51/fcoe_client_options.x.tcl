...
#? master type "::hag::ixnmeta::/vport/protocolStack/fcoeClientOptions"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/fcoeClientOptions
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/fcoeClientOptions]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/fcoeClientOptions'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/fcoeClientOptions {
  ...
  typevariable GenerateOptions {
    ...
    -anx2hlt-hltapi-param-element-attrs {//vport/protocolStack/fcoeClientOptions,associates,value_translator cgs.xlt.fcoe_client_options_associates}
    -anx2hlt-typepath-links {}
    -children-processing include-all
    -children-processing-for-types {}
    -command-name fcoe_client_options
  ...
  option -associates \
    -cgetmethod _g_associates -configuremethod _c_associates -validatemethod _v_associates \
    -default "" \
    -readonly false
  method _c_associates {t v} { $self _configure_basic $t $v }
  method _v_associates {t v} { ::ixia::hag::ixn::validate::kArray $t $v }
  method _g_associates {t} { $self _cget_basic $t }
...
#@ ancestors for ::hag::ixnmeta::/vport/protocolStack/fcoeClientOptions
...
#@ end of ancestors for ::hag::ixnmeta::/vport/protocolStack/fcoeClientOptions
...
if {[file exists [set dir]/tailor_fcoeClientOptions.tcl]} {
    set fn [set dir]/tailor_fcoeClientOptions.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
} elseif {[file exists [set dir]/../tailor_fcoeClientOptions.tcl]} {
    set fn [set dir]/../tailor_fcoeClientOptions.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
}
...
if 0 { 
    if {![set file_found]} {
      return -code error  "Could not find required tailorfile 'tailor_fcoeClientOptions.tcl'"
    }
}

#-------------------------------------------------------------
# Generated by the hag on 
#     Sun Aug 02 04:37:25 PDT 2015
#-------------------------------------------------------------
# package requires, etc.
package require snit
#-------------------------------------------------------------

if {[llength [info commands ::ixia::fcoe_client_options]]} {
    rename ::ixia::fcoe_client_options ""
}
::ixia::hag::ixn::types::shell ::ixia::fcoe_client_options  -config-multiplier-option-groups 1  -config-typepathways  [list /vport/protocolStack/fcoeClientOptions]
#
...
proc ::ixia::fcoe_client_options_config {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::fcoe_client_options config [set args]] r]
    if {$fail} {
    ...
    eval [concat {::ixia::fcoe_client_options config} [set args]]
  }
}

proc ::ixia::fcoe_client_options_control {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "fcoe_client_options: control not supported"]]
  } else {
      return -code error "fcoe_client_options: control not supported"
  }
}

proc ::ixia::fcoe_client_options_stats {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
      return [list [list status 0] [list log "fcoe_client_options: stats not supported"]]
  } else {
      return -code error "fcoe_client_options: stats not supported"
  }
}
