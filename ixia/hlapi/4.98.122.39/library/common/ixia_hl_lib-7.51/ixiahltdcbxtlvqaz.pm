...
package ixiahltdcbxtlvqaz;
##
my @cmd_spec_list = (
    ['dcbxtlvqaz_config', 'status', 'log', 'handles'],
    ['dcbxtlvqaz_control', 'status', 'log', '*'],
    ['dcbxtlvqaz_stats', 'status', 'log', '*'],
);
...
print("using " . File::Spec->join(
 File::Spec->rel2abs(File::Basename::dirname(__FILE__)), 'dcbxtlvqaz.x.tcl') . "
");
