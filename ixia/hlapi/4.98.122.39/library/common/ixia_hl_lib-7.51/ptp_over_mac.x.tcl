...
#? master type "::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac"..
#------------------------------------------------------------------
# Prolog for: /vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac
...
if {[llength [info commands ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac]]} {
    #puts stderr "Note: There was already a command called 'snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac'"
}

snit::type ::ixia::hag::ixn::types::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac {
  ...
  typevariable GenerateOptions {
    ...
    -type-for-command ethernetEndpoint/range/ptpRangeOverMac
    -use-settings-for typical_ethernet_based_stackmanager_extension_command
  }
  
  # ixn typepath associated w/ this obj
  variable TypePath /vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac
...
#@ ancestors for ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac
#@ end of ancestors for ::hag::ixnmeta::/vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac
...
if {[file exists [set dir]/tailor_ethernetEndpoint_range_ptpRangeOverMac.tcl]} {
    set fn [set dir]/tailor_ethernetEndpoint_range_ptpRangeOverMac.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
} elseif {[file exists [set dir]/../tailor_ethernetEndpoint_range_ptpRangeOverMac.tcl]} {
    set fn [set dir]/../tailor_ethernetEndpoint_range_ptpRangeOverMac.tcl
    uplevel #0 [list namespace eval :: [list source [set fn]]]
    set file_found 1
}
...
if 1 { 
    if {![set file_found]} {
      return -code error  "Could not find required tailorfile 'tailor_ethernetEndpoint_range_ptpRangeOverMac.tcl'"
    }
}

#-------------------------------------------------------------
# Generated by the hag on 
#     Sun Aug 02 04:44:26 PDT 2015
#-------------------------------------------------------------
# package requires, etc.
package require snit
#-------------------------------------------------------------

if {[llength [info commands ::ixia::ptp_over_mac]]} {
    rename ::ixia::ptp_over_mac ""
}
::ixia::hag::ixn::types::shell ::ixia::ptp_over_mac  -config-multiplier-option-groups 1  -config-typepathways  [list /vport/protocolStack/ethernetEndpoint/range/ptpRangeOverMac]
#
...
proc ::ixia::ptp_over_mac_config {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::ptp_over_mac config [set args]] r]
    if {$fail} {
    ...
    eval [concat {::ixia::ptp_over_mac config} [set args]]
  }
}

proc ::ixia::ptp_over_mac_control {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail [catch  [concat ::ixia::ptp_over_mac control [set args]] r]
    if {$fail} {
      return [list [list status 0] [list log $r\n$::errorInfo]]
    } else {
...
proc ::ixia::ptp_over_mac_stats {args} {
  set procName [lindex [info level [info level]] 0]
  ::ixia::logHltapiCommand $procName $args
  ::ixia::utrackerLog $procName $args
  if {$::ixia::hag::ixn::Opts(keyedListReturnValues)} {
    set fail  [catch [concat {::ixia::ptp_over_mac stats} [set args]] r]
    if {$fail} {
      return [list [list status 0] [list log $r\n$::errorInfo]]
    } else {
    ...
    eval [concat {::ixia::ptp_over_mac stats} [set args]]
  }
}
